...
| [Protocols](protocols.md) | Mint, Pay, and Registration step-by-step |
| [Unlinkability & Threat Model](threat-model.md) | Formal adversary model and unlinkability argument |
| [Running the System](running.md) | Setup, local run, Docker demo, CI |
